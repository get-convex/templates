...
import { counterClient, defineCounter } from "@convex-dev/counter";

const counter = counterClient(components.counter, { shards: { beans: 100 } });
// alternative way to define a specific counter
